...
class LanguageController extends Controller
{
    public function index()
    {
        ...
        return view('employee.language.index', compact('languages'));
    }

    public function create()
    {
        return view('employee.language.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee.language.index')->with('success', 'Language created successfully.');
    }

    public function edit(Language $language)
    {
        return view('employee.language.edit', compact('language'));
    }
    ...
    public function update(Request $request, Language $language)
    {
        ...
        return redirect()->route('employee.language.index')->with('success', 'Language updated successfully.');
    }
