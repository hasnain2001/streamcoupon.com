    ...
    <tr class="row1 align-middle" data-id="{{ $coupon->id }}">
        ...
        <td>
            <div class="d-flex align-items-center">
                ...
                <span>{{ $coupon->stores->name ?? 'null'}}</span>
            </div>
        </td>
        <td>
            @if ($coupon->code)
                <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-10 px-3 py-2 text-white">
                    <i class="fas fa-code me-1"></i> Code
                </span>
            @else
                <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-10 px-3 py-2 text-white">
        ...
        <td>
            ...
            @else
                <span class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-10 px-3 py-2 text-white">
        ...
        <td>
                 <div class="me-3">
                    ...
                    <span>{{ $coupon->user->name ?? 'Unknown' }}</span>
                </div>
                  <div class="me-3">
                    <i class="fas fa-user-circle text-secondary me-1"></i>
