            ...
            <div class="card">
                ...
                @if ($errors->any())
                    ...
                    @endif
                        ...
                        <form action="{{ route('admin.store.update', $store->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- Left Column -->
                                ...
                                <div class="card mb-3 border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="network_id" id="network" class="form-select text-capitalize" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($store->image)
                                                <div class="mt-2">
                                                    ...
                                                    <img src="{{ asset('uploads/stores/' . $store->image) }}" alt="Current Store Image" class="img-thumbnail" style="max-width: 200px;">
