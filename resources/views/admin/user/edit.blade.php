    ...
    <div class="col-lg-10">
        <div class="card shadow-lg border-0">
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('admin.user.update', $user->id) }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data" id="userForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0">Update user details and information</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="email" class="form-control shadow-sm" id="email" name="email"
                                       placeholder="name@example.com" required value="{{ old('email', $user->email) }}"
                                       oninput="validateField(this)">
            ...
            <small class="text-muted" id="passwordHint">Leave blank to keep current password</small>
                        ...
                        <div class="col-12">
                            <div class="section-header mb-4 mt-2">
                                ...
                                <p class="text-muted mb-0">Update user access level and permissions</p>
                            </div>
                            ...
                            <div class="role-description mt-3 p-3 bg-light rounded" id="roleDescription">
                        ...
                        <div class="col-12">
                            <div class="section-header mb-4 mt-2">
                                ...
                                <p class="text-muted mb-0">Update profile picture (optional)</p>
                            </div>
                                        ...
                                        <div class="file-upload-area">
                                            ...
                                            <div class="mt-2">
                                                <button type="button" class="btn btn-outline-secondary btn-sm" onclick="clearAvatar()">
                                                    <i class="fas fa-times me-1"></i>Clear New Image
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="section-header mb-4 mt-2">
                                <h5 class="text-primary mb-2">
                                    <i class="fas fa-chart-bar me-2"></i>User Information
                                </h5>
                                <p class="text-muted mb-0">Additional user details</p>
                            </div>
                                    ...
                                    <div class="info-card p-3 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-0 text-muted">{{ $user->created_at->format('M d, Y') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="info-card p-3 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-0 text-muted">{{ $user->updated_at->format('M d, Y') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
.bg-gradient-warning {
    background: linear-gradient(135deg, #f1b44c 0%, #e6a841 100%) !important;
}
</style>
@endsection
...
function validatePasswordMatch() {
    ...
    if (!password) {
        // If password is empty, clear confirmation field and validation
...
function removeAvatar() {
    if (confirm('Are you sure you want to remove the current profile picture?')) {
        // You can implement AJAX call to remove avatar here
        // For now, we'll just show a message
        alert('Avatar removal would be handled via AJAX in a real implementation.');
    }
}
