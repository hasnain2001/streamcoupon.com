...
<div class="container-fluid px-3 px-lg-4">
    ...
    <div class="search-filter-section">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-1 text-end">
                <button class="btn btn-outline-secondary btn-sm" id="resetFilters" title="Reset all filters">
    ...
    <div class="card users-table-wrapper">
        ...
        @if($users->count() > 0)
        <div class="card-footer bg-white border-top-0 d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <span class="text-muted">
                    Showing <strong id="visibleCount">{{ $users->count() }}</strong> users
                </span>
            </div>
            <div>
...
<div class="modal fade user-modal" id="userDetailsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-4" id="userDetailsContent"></div>
        </div>
    </div>
</div>
...
<style>
    ...
    .page-title-wrapper, .header-actions {
        position: relative;
        z-index: 2;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-user-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (!deleteUrl) {
                showToast('error', 'Delete URL missing!');
                return;
            }

            userToDelete = { id: userId, url: deleteUrl };
    ...
    window.showUserDetails = function(user) {
        ...
        const avatarHtml = user.avatar
            ? `<img src="${user.avatar_url}" alt="${user.name}" class="rounded-circle shadow-lg mb-3" width="120" height="120" onerror="this.onerror=null;this.src='{{ asset('admin/img/user.png') }}'">`
            : `<div class="rounded-circle shadow-lg d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 120px; height: 120px; background: var(--primary-gradient);"><i class="fas fa-user fa-3x text-white"></i></div>`;
    ...
    window.applyFilters = function() {
        // In a real app, you'd apply server-side filters; here we just show a toast.
        showToast('info', 'Filters applied (demo)');
    ...
    function showToast(type, message) {
        ...
        toast.innerHTML = `
            <div class="toast align-items-center text-white ${toastClass} border-0 show" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
    ...
    // Auto-close alerts (if any are displayed via session)
    setTimeout(() => {
    ...
    // Show session messages as toasts (optional)
    @if(session('success'))
