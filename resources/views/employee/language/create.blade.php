...
@section('content')
@include('components.employee.page-header', [
    'title' => 'Add New Language',
    'breadcrumbs' => [
        'Ubold' => route('employee.dashboard'),
        'Languages' => route('employee.language.index'),
        'Add New' => 'active'
    ]
])
    ...
    <div class="col-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                @endif
                   <form name="Createlanguage" id="Createlanguage" method="POST" action="{{ route('employee.language.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('employee.language.index') }}" class="btn btn-light">
