        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        <a href="{{ route('employee.store.index') }}" class="btn btn-secondary">
                ...
                <div class="row mb-4">
                    <div class="col-md-8 mx-auto">
                        <div class="search-box position-relative">
                            <form id="searchForm" action="{{ route('employee.search') }}" method="GET">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="stores-tab" role="tabpanel">
                        @include('employee.search.partials.stores', ['stores' => $stores])
                    </div>

                    <!-- Coupons Tab -->
                    <div class="tab-pane" id="coupons-tab" role="tabpanel">
                        @include('employee.search.partials.coupons', ['coupons' => $coupons])
                    </div>

                    <!-- Blogs Tab -->
                    <div class="tab-pane" id="blogs-tab" role="tabpanel">
                        @include('employee.search.partials.blogs', ['blogs' => $blogs])
                    </div>

                    <!-- Categories Tab -->
                    <div class="tab-pane" id="categories-tab" role="tabpanel">
                        @include('employee.search.partials.categories', ['categories' => $categories])
                    </div>

                    <!-- Networks Tab -->
                    <div class="tab-pane" id="networks-tab" role="tabpanel">
                        @include('employee.search.partials.networks', ['networks' => $networks])
                    </div>
                </div>
                @elseif(isset($query))
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('employee.store.index') }}" class="btn btn-primary mt-2">
...
$(document).ready(function() {
    ...
    searchForm.on('submit', function(e) {
        ...
        window.location.href = '{{ route("employee.search.index") }}?query=' + encodeURIComponent(query);
    });
