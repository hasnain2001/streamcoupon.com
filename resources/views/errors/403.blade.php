...
@section('content')
    <div class="error-container">
        ...
        {{-- Error Code with forbidden icon --}}
        ...
        <p class="error-message">
            {{ __($exception->getMessage() ?: 'You do not have permission to access this page. Please contact support if you believe this is an error.') }}
        </p>
        ...
        <div class="action-buttons">
            ...
            @if(config('app.support_email'))
                <a href="mailto:{{ config('app.support_email') }}" class="btn-outline-help">
    ...
    @push('styles')
        <style>
            ...
            .error-code i {
                font-size: 0.65em;
                -webkit-text-fill-color: #ef4444; /* red shade for forbidden */
                color: #ef4444;
                background: none;
            }
            .error-code span {
            ...
            /* Optional: if you want the "Contact Support" button to be more prominent */
            .btn-outline-help i {
                font-size: 0.9em;
            }
