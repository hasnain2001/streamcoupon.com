...
@section('content')
    <div class="error-container">
        ...
        <p class="error-message">
            {{ __('The page you were viewing has expired due to inactivity. Please refresh the page or go back and try again.') }}
        </p>
    ...
    @push('styles')
        <style>
            ...
            .error-code i {
                font-size: 0.65em;
                -webkit-text-fill-color: #f59e0b; /* amber for expiry */
                color: #f59e0b;
                background: none;
            }
            .error-code span {
