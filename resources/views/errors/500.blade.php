...
@section('content')
    <div class="error-container">
        ...
        {{-- Optional: reference ID if your logs provide it --}}
        @if (isset($exception) && method_exists($exception, 'getTraceId'))
            <p class="error-reference mt-3">
                <small>{{ __('Reference ID: :id', ['id' => $exception->getTraceId()]) }}</small>
            </p>
        @endif
    </div>
    ...
    @push('styles')
        <style>
            ...
            /* Decorative glows (red tint for server error) */
            ...
            .error-code {
                ...
                background: linear-gradient(135deg, #dc2626 0%, #7c3aed 50%, #ec4899 100%);
                ...
                filter: drop-shadow(0 8px 24px rgba(220, 38, 38, 0.20));
            }
            .error-code i {
                font-size: 0.65em;
                -webkit-text-fill-color: #dc2626; /* red for server error */
                color: #dc2626;
                background: none;
            }
            .error-code span {
            ...
            @keyframes pulseGlow {
                0%, 100% { filter: drop-shadow(0 8px 24px rgba(220, 38, 38, 0.20)); }
                50% { filter: drop-shadow(0 12px 40px rgba(220, 38, 38, 0.40)); }
            }
